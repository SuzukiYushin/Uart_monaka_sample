...
//  UartSample
//
//  Created by kizusuMac on 13/02/22.
...
@implementation Konashi2
#pragma mark -
#pragma mark - Singleton

+ (Konashi2 *) shared
{
    static Konashi2 *_monaka = nil;
    
    @synchronized (self){
        static dispatch_once_t pred;
        dispatch_once(&pred, ^{
            _monaka = [[Konashi2 alloc] init];
        });
    }
...
+ (int) initialize
{
    return [[Konashi2 shared] _initializeKonashi];
}

+ (int) find
{
    return [[Konashi2 shared] _findModule:2];
}

+ (int) disconnect
{
    return [[Konashi2 shared] _disconnectModule];
}

+ (BOOL) isConnected
{
    return [[Konashi2 shared] _isConnected];
}
...
{
    return [[Konashi2 shared] _pinMode:pin mode:mode];
}

+ (int) pinModeAll:(int)mode
{
    return [[Konashi2 shared] _pinModeAll:mode];
}

+ (int) pinPullup:(int)pin mode:(int)mode
{
    return [[Konashi2 shared] _pinPullup:pin mode:mode];
}

+ (int) pinPullupAll:(int)mode
{
    return [[Konashi2 shared] _pinPullupAll:mode];
}

+ (int) digitalRead:(int)pin
{
    return [[Konashi2 shared] _digitalRead:pin];
}

+ (int) digitalReadAll
{
    return [[Konashi2 shared] _digitalReadAll];
}

+ (int) digitalWrite:(int)pin value:(int)value
{
    return [[Konashi2 shared] _digitalWrite:pin value:value];
}

+ (int) digitalWriteAll:(int)value
{
    return [[Konashi2 shared] _digitalWriteAll:value];
}
...
{
    return [[Konashi2 shared] _pwmMode:pin mode:mode];
}

+ (int) pwmPeriod:(int)pin period:(unsigned int)period
{
    return [[Konashi2 shared] _pwmPeriod:pin period:period];
}

+ (int) pwmDuty:(int)pin duty:(unsigned int)duty
{
    return [[Konashi2 shared] _pwmDuty:pin duty:duty];
}

+ (int) pwmLedDrive:(int)pin dutyRatio:(int)ratio
{
    return [[Konashi2 shared] _pwmLedDrive:pin dutyRatio:ratio];
}
...
{
    return [[Konashi2 shared] _analogReadRequest:pin];
}

+ (int) analogRead:(int)pin
{
    return [[Konashi2 shared] _analogRead:pin];
}

+ (int) analogWrite:(int)pin milliVolt:(int)milliVolt
{
    return [[Konashi2 shared] _analogWrite:pin milliVolt:(int)milliVolt];
}
...
{
    return [[Konashi2 shared] _i2cMode:mode];
}

+ (int) i2cStartCondition
{
    return [[Konashi2 shared] _i2cSendCondition:KONASHI_I2C_START_CONDITION];
}

+ (int) i2cRestartCondition
{
    return [[Konashi2 shared] _i2cSendCondition:KONASHI_I2C_RESTART_CONDITION];
}

+ (int) i2cStopCondition
{
    return [[Konashi2 shared] _i2cSendCondition:KONASHI_I2C_STOP_CONDITION];
}

+ (int) i2cWrite:(int)length data:(unsigned char*)data address:(unsigned char)address
{
    return [[Konashi2 shared] _i2cWrite:length data:data address:address];
}

+ (int) i2cReadRequest:(int)length address:(unsigned char)address
{
    return [[Konashi2 shared] _i2cReadRequest:length address:address];
}

+ (int) i2cRead:(int)length data:(unsigned char*)data
{
    return [[Konashi2 shared] _i2cRead:length data:data];
}
...
{
    return [[Konashi2 shared] _uartMode:mode];
}

+ (int) uartBaudrate:(int)baudrate
{
    return [[Konashi2 shared] _uartBaudrate:baudrate];
}

+ (int) uartWrite:(unsigned char)data
{
    return [[Konashi2 shared] _uartWrite:data];
}

+ (unsigned char) uartRead
{
    return [[Konashi2 shared] _uartRead];
}
...
+ (int) reset
{
    return [[Konashi2 shared] _resetModule];
}

+ (int) batteryLevelReadRequest
{
    return [[Konashi2 shared] _batteryLevelReadRequest];
}

+ (int) batteryLevelRead
{
    return [[Konashi2 shared] _batteryLevelRead];
}

+ (int) signalStrengthReadRequest
{
    return [[Konashi2 shared] _signalStrengthReadRequest];
}

+ (int) signalStrengthRead
{
    return [[Konashi2 shared] _signalStrengthRead];
}
...
{
    cm = [[CBCentralManager alloc] initWithDelegate:[Konashi2 shared] queue:nil];
...
- (void) readyModule
{
    ...
    [[Konashi2 shared] postNotification:KONASHI_EVENT_READY];
...
- (int) _pwmMode:(int)pin mode:(int)mode
{
    if(pin >= PIO0 && pin <= PIO7 && (mode == KONASHI_PWM_DISABLE || mode == KONASHI_PWM_ENABLE || mode == KONASHI_PWM_ENABLE_LED_MODE )){
        ...
        // Write value
        return [[Konashi2 shared] _writeValuePwmSetting];
    }
    else{
        return KONASHI_FAILURE;
    }
...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral
{
    ...
    [[Konashi2 shared] postNotification:KONASHI_EVENT_CONNECTED];
    ...
    if (!error) {
        switch(characteristicUUID){
            case KONASHI_PIO_INPUT_NOTIFICATION_UUID:
            {
                ...
                pioInput = byte[0];
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_PIO_INPUT];
            ...
            case KONASHI_ANALOG_READ0_UUID:
            {
                ...
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_ANALOG_VALUE];
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO0];
            ...
            case KONASHI_ANALOG_READ1_UUID:
            {
                ...
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_ANALOG_VALUE];
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO1];
            ...
            case KONASHI_ANALOG_READ2_UUID:
            {
                ...
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_ANALOG_VALUE];
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_ANALOG_VALUE_AIO2];
            ...
            case KONASHI_I2C_READ_UUID:
            {
                ...
                [[Konashi2 shared] postNotification:KONASHI_EVENT_I2C_READ_COMPLETE];
            ...
            case KONASHI_UART_RX_NOTIFICATION_UUID:
            {
                ...
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UART_RX_COMPLETE];
            ...
            case KONASHI_LEVEL_SERVICE_UUID:
            {
                ...
                [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_BATTERY_LEVEL];
...
- (void)peripheralDidUpdateRSSI:(CBPeripheral *)peripheral error:(NSError *)error
{
    ...
    [[Konashi2 shared] postNotification:KONASHI_EVENT_UPDATE_SIGNAL_STRENGTH];
}
